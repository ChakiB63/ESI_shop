...
<body class="grey lighten-3">
  ...
  <main class="mt-5 pt-4">
    <div class="container wow fadeIn">
      ...
      <!-- Heading -->
      <h2 class="my-5 h2 r">Sign up form</h2>
      ...
      <div class="row">
        ...
        <div class="col-md-8 mb-4">
          ...
          <div class="card">
            ...
            <!--Card content-->
            <form class="card-body" method="post" action="./SignupServlet">
            <%
            ...
            <span class="text-muted">Personnal information</span>
          </h4>
          	...
          	<h4 class="d-flex justify-content-between align-items-center mb-3">
            <span class="text-muted">Coordinates to log in</span>
          </h4>
             ...
             <!--Username-->
              <div class="md-form input-group pl-0 mb-5">
               ...
               <div class="md-form mb-5">
                <input type="text" id="password" class="form-control" placeholder="1234 Main St" name="password">
