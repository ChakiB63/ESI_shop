...
<% }%>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<% if(request.getAttribute("role")=="admin"){%>
          <li class="nav-item">
            <a class="nav-link waves-effect" href="modifyin.jsp">
  ...
  <main class="mt-5 pt-4">
    <div class="container wow fadeIn">
      ...
      <!-- Heading -->
      <h2 class="my-5 h2 r text-center">Updating form</h2>
      ...
      <div class="row">
        ...
        <div class="col-md-8 mb-4">
          ...
          <div class="card">
            ...
            <span class="text-muted">Update product</span>
          </h4>

              <div class="md-form mb-5">
                <input type="text" id="email" class="form-control" placeholder="" name="name" value="<%%>">
